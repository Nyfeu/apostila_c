...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{imagens/esp32_diagram_upscayl_5x_upscayl-standard-4x.png}
\caption{Diagrama de blocos das features do microcontrolador ESP32.}
\end{figure}
...
\begin{enumerate}
    \item Não existe uma função \code{main} que ``termina'' — como adiantado no \cref{cap:primeiros-passos}, o firmware roda indefinidamente em torno de um \textbf{laço principal}, reagindo a eventos e atualizando o estado do sistema enquanto houver energia;
