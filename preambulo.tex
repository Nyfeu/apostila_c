...
% ---- Ajuste fino de quebra de linha ---------------------------
% Reduz "overfull hbox" causados por trechos com \code{} e \cref{}
% que não podem ser hifenizados, sem alterar o conteúdo do texto.
...
\tcbset{
  codigobase/.style={
    ...
    before skip=15pt,   % <-- Espaçamento superior restaurado
    after skip=15pt,    % <-- Espaçamento inferior restaurado
    coltext=textoclaro, % <-- Substitui o "before" e aplica a cor corretamente
  ...
  terminalbase/.style={
    breakable, enhanced, listing only, minted style=native, % <-- Tema para terminal escuro
    minted options={fontsize=\small, breaklines, breakanywhere,
                     tabsize=4, baselinestretch=1.05},
    ...
    before skip=15pt,   % <-- Espaçamento superior restaurado
    after skip=15pt,    % <-- Espaçamento inferior restaurado
    coltext=textoclaro, % <-- Força cor clara no texto comum do terminal
  }
}
